 ...
 */
public class LogcatFloatView extends FrameLayout {
    ...
    public LogcatFloatView(Context context) {
        super(context);
    ...
    private void initData() {
        ...
        logAdapter = new ArrayAdapter<>(getContext(), R.layout.layout_logcat_float_item, logList);

        refreshLogView(LogcatManager.VERSION_INFO);
    }

    private void initView() {
        mRootView = View.inflate(getContext(), R.layout.layout_logcat_float, null);
